...
// on resize
const sizeUpdateTimestamp = computed(() => useClientStore().sizeUpdateTimestamp)
...
<template>
  <section class="h-300vh">
    <div v-once ref="container" class="h-full">
      ...
      <div class="h-100vh" />
      <div class="w-full h-100vh relative z-0 flex items-center justify-center font-bold text-white text-10 lg:text-16" v-t="'thank'" />
    </div>
  </section>
</template>
