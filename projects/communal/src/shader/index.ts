 ...
 */
export const createShaderTween = async (canvas: HTMLCanvasElement, { bg, bg2, noise, noise2 }: { bg: string; bg2: string; noise: string; noise2: string }, init = true): Promise<TweenShader> => {
