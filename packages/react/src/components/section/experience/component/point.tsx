    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="work__head mb-3 flex items-center rounded-1.5">
          {/*date*/}
          {details.date && (
            <div className="work__head-date inline-block bg-white px-3 py-1.5 rounded-l-1.5 font-bold">
              {details.date}
            </div>
          )}
          {/*title*/}
        ...
        {('end' in details || 'team' in details) && (
          <div className="pl-4 leading-0 whitespace-nowrap mb-3">
            <span
              className="work__end leading-4 inline-block text-4 m-0 px-2 py-1.5 rounded-l"
              data-color={details.end}
            >
              {t(`end.${details.end}`)}
            </span>
            <span
              className="work__team leading-4 inline-block text-4 m-0 px-2 py-1.5 bg-white rounded-r"
